...
OPTEE_SSERVICES_PATH		?= $(ROOT)/secure-services
OPTEE_SSERVICES_EXPORT		?= $(ROOT)/secure-services/out/export
...
BR2_PACKAGE_SSERVICES_EXT ?= y
BR2_PACKAGE_SSERVICES_EXT_SITE ?= $(OPTEE_SSERVICES_PATH)
BR2_PACKAGE_SSERVICES_EXT_SDK ?= $(OPTEE_OS_TA_DEV_KIT_DIR)
BR2_PACKAGE_SSERVICES_EXT_CROSS_COMPILE ?= $(CROSS_COMPILE_S_USER)
...
XTEST_COMMON_FLAGS ?= CROSS_COMPILE_HOST=$(CROSS_COMPILE_NS_USER)\
	...
	OPTEE_SSERVICES_EXPORT=$(OPTEE_SSERVICES_EXPORT) \
	COMPILE_NS_USER=$(COMPILE_NS_USER) \
	O=$(OPTEE_TEST_OUT_PATH)

.PHONY: xtest-common
xtest-common: optee-os optee-client-common sservices-common
...
################################################################################
# Secure Services library and corresponding TA
################################################################################
SSERVICES_COMMON_FLAGS ?= CROSS_COMPILE=$(CROSS_COMPILE_NS_USER)\
	TA_DEV_KIT_DIR=$(OPTEE_OS_TA_DEV_KIT_DIR) \
	OPTEE_CLIENT_EXPORT=$(OPTEE_CLIENT_EXPORT)

.PHONY: sservices-common
sservices-common: optee-os optee-client-common
	$(MAKE) -C $(OPTEE_SSERVICES_PATH) $(SSERVICES_COMMON_FLAGS)

SSERVICES_CLEAN_COMMON_FLAGS ?= TA_DEV_KIT_DIR=$(OPTEE_OS_TA_DEV_KIT_DIR)

.PHONY: sservices-clean-common
sservices-clean-common:
	$(MAKE) -C $(OPTEE_SSERVICES_PATH) \
			$(SSERVICES_CLEAN_COMMON_FLAGS) clean
